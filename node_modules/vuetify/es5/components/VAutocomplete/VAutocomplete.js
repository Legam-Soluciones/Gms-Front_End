...
var _default2 = _VSelect.default.extend({
  ...
  methods: {
    ...
    setSearch: function setSearch() {
      ...
      this.$nextTick(function () {
        if (!_this7.multiple || !_this7.internalSearch || !_this7.isMenuActive) {
          _this7.internalSearch = !_this7.selectedItems.length || _this7.multiple || _this7.hasSlot ? null : _this7.getText(_this7.selectedItem);
        }
      });
    },
